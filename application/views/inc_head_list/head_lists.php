...
<html class="fixed">
    <head>
        ...
        <meta name="keywords" content="HTML5 public Template" />
        <meta name="description" content="Porto public - Responsive HTML5 Template">
        ...
        <link rel="stylesheet" href="<?php echo base_url() ;?>public/vendor/select2/select2.css" />
        <link rel="stylesheet" href="<?php echo base_url() ;?>public/vendor/jquery-datatables-bs3/assets/css/datatables.css" />
