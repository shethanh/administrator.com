<!-- Vendor -->
        ...
        <script src="<?php echo base_url() ;?>public/vendor/select2/select2.js"></script>
        <script src="<?php echo base_url() ;?>public/vendor/jquery-datatables/media/js/jquery.dataTables.js"></script>
        <script src="<?php echo base_url() ;?>public/vendor/jquery-datatables/extras/TableTools/js/dataTables.tableTools.min.js"></script>
        <script src="<?php echo base_url() ;?>public/vendor/jquery-datatables-bs3/assets/js/datatables.js"></script>
        ...
        <!-- Examples -->
        <script src="<?php echo base_url() ;?>public/javascripts/tables/examples.datatables.default.js"></script>
        <script src="<?php echo base_url() ;?>public/javascripts/tables/examples.datatables.row.with.details.js"></script>
        <script src="<?php echo base_url() ;?>public/javascripts/tables/examples.datatables.tabletools.js"></script>
    </body>
</html>