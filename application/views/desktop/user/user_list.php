            ...
            <section class="panel">
              <header class="panel-heading">
                <div class="panel-actions">
                    ...
                    <button id="addToTable" class="btn btn-success">List <i class="fa fa-list"></i></button>
                    <button id="addToTable" class="btn btn-danger">Blocked/Disable <i class="fa fa-calendar-o"></i></button>
                  <a href="#" class="fa fa-caret-down"></a>
                  <a href="#" class="fa fa-times"></a>
                </div>
                <h2 class="panel-title">User Lists</h2>
              </header>  
                ...
                <table class="table table-bordered table-striped mb-none" id="datatable-tabletools" data-swf-path="<?php echo base_url() ;?>public/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
                  <thead>
                    <tr>
                      ...
                      <th class="hidden-address">User Level</th>
