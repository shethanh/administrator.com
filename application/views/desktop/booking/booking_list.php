            ...
            <section class="panel">
              <header class="panel-heading">
                <div class="panel-actions">
                    <button id="addToTable" class="btn btn-primary">Hotels <i class="fa fa-plus-square"></i></button>
                    <button id="addToTable" class="btn btn-success">Bus <i class="fa fa-list"></i></button>
                    <button id="addToTable" class="btn btn-danger">Tours <i class="fa fa-calendar-o"></i></button>
                  <a href="#" class="fa fa-caret-down"></a>
                  <a href="#" class="fa fa-times"></a>
                </div>
                <h2 class="panel-title">Booking Lists</h2>
              </header>  
                ...
                <table class="table table-bordered table-striped mb-none" id="datatable-tabletools" data-swf-path="<?php echo base_url() ;?>public/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
                  <thead>
                    <tr>
                      ...
                      <th class="hidden-address">Guest Name</th>
                      <th class="hidden-address">Phone Number</th>
