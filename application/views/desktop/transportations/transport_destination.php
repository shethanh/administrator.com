            ...
            <section class="panel">
              <header class="panel-heading">
                <div class="panel-actions">
                    <button id="addToTable" class="btn btn-primary" onclick="window.location = '<?php echo base_url()?>transportations/add';">Add <i class="fa fa fa-plus-square"></i></button>
                    <button id="addToTable" class="btn btn-success">Lists <i class="fa fa-list"></i></button>
                  <a href="#" class="fa fa-caret-down"></a>
                  <a href="#" class="fa fa-times"></a>
                </div>
                <h2 class="panel-title">Transport Destination</h2>
              </header>  
                ...
                <table class="table table-bordered table-striped mb-none" id="datatable-tabletools" data-swf-path="<?php echo base_url() ;?>public/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
                  <thead>
                    <tr>
                      ...
                      <th class="hidden-address">City/Place</th>
                      <th class="hidden-address">Country</th>
                      <th class="hidden-address">Address</th>
                      <th class="hidden-address">Contact</th>
                      <th class="hidden-option"><center>Option</center></th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr class="gradeX">
