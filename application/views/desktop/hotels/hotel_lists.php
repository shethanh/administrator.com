            ...
            <section class="panel">
              <header class="panel-heading">
                <div class="panel-actions">
                    <button id="addToTable" class="btn btn-primary" onclick="window.location = '<?php echo base_url()?>hotels/add';">Add <i class="fa fa-plus-square"></i></button>
                ...
                <h2 class="panel-title">Hotel Lists</h2>
              </header>  
